<!DOCTYPE html>
<html lang="en">
        <head><title>Tech-Information</title>
        <meta charset="UTF-8">
        ...
        <body onload="myclock()">
            ...
            <div class="post_body">
                <?php
			        ...
			        $query = "Select * from tech_posts order by rand() LIMIT 0,4 "; 
			        ...
			        while( $row = mysql_fetch_array($run))
			        {
                        ...
                        $content = substr($row['tech_content'],0,200);				
        	    ?>
		            <h2><a href="tech_page.php?id=<?php echo $post_id; ?>"><?php echo $title; ?></a></h2>
			        ...
			        <p align="right"><a href="tech_page.php?id=<?php echo $post_id;?>">Read more</a></p>			
                <?php }?>
            </div>           
            <!-- this is footer -->
