...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query = " insert into sport_posts(sport_title,sport_date,sport_author,sport_socail_link,sport_image,sport_content) values('$title','$date','$author','$socail_link','$image_name','$content')";
        if (mysql_query($query)) 
        {
            
            echo "<script>window.open('index.php?sport_published=Sport Post has been published','_self')</script>";
        } 
    }
?>
<?php } ?>