...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query = " insert into posts(post_title,post_date,post_author,post_socail_link,post_image,post_content) values('$title','$date','$author','$socail_link','$image_name','$content')";
