<!DOCTYPE html>
<html lang="en">
        <head><title>Sport-Information</title>
        <meta charset="UTF-8">
        ...
        <body onload="myclock()">
            ...
            <div class="post_body">
                <?php
			        ...
			        $query = "Select * from sport_posts order by rand() LIMIT 0,4 "; 
			        ...
			        while( $row = mysql_fetch_array($run))
			        {
                        ...
                        $content = substr($row['sport_content'],0,200);				
        	    ?>
		            <h2><a href="sport_page.php?id=<?php echo $post_id; ?>"><?php echo $title; ?></a></h2>
			        ...
			        <p align="right"><a href="sport_page.php?id=<?php echo $post_id;?>">Read more</a></p>			
                <?php }?>
            </div>           
            <!-- this is footer -->
